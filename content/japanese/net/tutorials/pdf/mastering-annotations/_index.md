...
PDF を扱ったことがあるなら、注釈が画期的な機能であることをご存知でしょう。注釈は付箋、蛍光ペン、落書きのようなもので、ドキュメントをインタラクティブで魅力的なものにします。しかし、この魔法をプログラムで実現するにはどうすればよいでしょうか。Aspose.PDF for .NET を使用すると、注釈のプロになれます。旅を始めるための重要なチュートリアルをいくつか見ていきましょう。
