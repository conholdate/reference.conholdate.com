---
title: 使用 GroupDocs.Signature 對 PDF 進行元資料簽署的指南
linktitle: 使用元資料簽署 PDF 的指南
second_title: GroupDocs.Signature .NET API
description: 了解如何使用 GroupDocs.Signature for .NET 使用元資料對 PDF 文件進行簽名，從而增強 PDF 文件的安全性和可追溯性。這個綜合教程提供了清晰的內容。
type: docs
weight: 11
url: /zh-hant/net/tutorials/signature/master-document-signing/signing-pdf-with-metadata/
---
## 介紹
